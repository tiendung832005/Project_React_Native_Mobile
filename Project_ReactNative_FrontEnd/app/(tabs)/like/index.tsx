    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.item}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.mainText}>
              <Text style={styles.username}>martini_rond </Text>started
              following you.
            </Text>
        ...
        <View style={styles.item}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.mainText}>
              <Text style={styles.username}>maxjacobson </Text>started following
              you.
            </Text>
            <Text style={styles.timeText}>3d</Text>
          </View>
        ...
        <View style={styles.item}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.mainText}>
              <Text style={styles.username}>mis_potter </Text>started following
              you.
            </Text>
            <Text style={styles.timeText}>3d</Text>
          </View>
